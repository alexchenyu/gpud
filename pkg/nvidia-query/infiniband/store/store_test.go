...
func TestNewStoreWithCustomValues(t *testing.T) {
	...
	assert.Equal(t, defaultRetentionPeriod, s.retention)
...
func TestStoreWithZeroRetentionAndPurge(t *testing.T) {
	...
	assert.Equal(t, defaultRetentionPeriod, s1.retention, "First store should use default retention")
	...
	assert.Equal(t, defaultRetentionPeriod, s2.retention, "Second store should also use default retention")
