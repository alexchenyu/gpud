	...
	tests := []struct {
	...
	}{
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: postgres, pid: 12345",
				},
			},
		},
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: apache2, pid: 9876",
				},
			},
		},
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: mysql, pid: 11111",
				},
				{
					eventName: "OOM",
		...
		},
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: stress, pid: 33333",
				},
			},
		},
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: evil-program2, pid: 19636",
				},
			},
		},
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: evil-program2, pid: 19667",
				},
			},
		},
		{
		...
		},
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: badsysprogram, pid: 11499",
				},
			},
		},
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: second-process, pid: 5555",
				},
			},
		},
	}
...
func TestOomInstanceSummary(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: "System OOM encountered, victim process: postgres, pid: 12345",
		},
		{
	...
	tests := []struct {
		...
		},
		{
			...
			expectedEvents: []struct {
				...
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: gunpowder-memho, pid: 1381",
				},
				{
					eventName: "OOM",
					message:   "System OOM encountered, victim process: gunpowder-memho, pid: 1667",
				},
			},
		},
	}
